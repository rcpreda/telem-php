<x-app-layout>
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">{{ __('car.create_car') }}</h3>
                        ...
                        <div class="card h-100 shadow-sm">
                            ...
                            <div class="card-body py-3">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" name="make" class="form-control form-control-sm @error('make') is-invalid @enderror" value="{{ old('make') }}" placeholder="{{ __('car.make_placeholder') }}" required>
                                        @error('make')
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" name="model" class="form-control form-control-sm @error('model') is-invalid @enderror" value="{{ old('model') }}" placeholder="{{ __('car.model_placeholder') }}" required>
                                        @error('model')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="number" name="year" class="form-control form-control-sm @error('year') is-invalid @enderror" value="{{ old('year') }}" placeholder="{{ __('car.year_placeholder') }}" min="1900" max="{{ date('Y') + 1 }}">
                                        @error('year')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" name="color" class="form-control form-control-sm @error('color') is-invalid @enderror" value="{{ old('color') }}" placeholder="{{ __('car.color_placeholder') }}">
                                        @error('color')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                        ...
                        <div class="card h-100 shadow-sm">
                            ...
                            <div class="card-body py-3">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" name="license_plate" class="form-control form-control-sm @error('license_plate') is-invalid @enderror" value="{{ old('license_plate') }}" placeholder="{{ __('car.license_plate_placeholder') }}">
                                        @error('license_plate')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" name="vin" class="form-control form-control-sm @error('vin') is-invalid @enderror" value="{{ old('vin') }}" placeholder="{{ __('car.vin_placeholder') }}">
                                        @error('vin')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="number" name="mileage" class="form-control form-control-sm @error('mileage') is-invalid @enderror" value="{{ old('mileage') }}" placeholder="{{ __('car.mileage_placeholder') }}" min="0">
                                        @error('mileage')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                        ...
                        <div class="card h-100 shadow-sm">
                            ...
                            <div class="card-body py-3">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" name="device_imei" class="form-control form-control-sm @error('device_imei') is-invalid @enderror" value="{{ old('device_imei') }}" placeholder="{{ __('car.device_imei_placeholder') }}">
                                        @error('device_imei')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-lg-8">
                                        <select name="fuel_type" class="form-select form-select-sm @error('fuel_type') is-invalid @enderror" data-control="select2" data-hide-search="true" data-placeholder="{{ __('car.select_fuel_type') }}">
                                            ...
                                            @foreach($fuelTypes as $fuelValue => $fuelLabel)
                                                <option value="{{ $fuelValue }}" {{ old('fuel_type') == $fuelValue ? 'selected' : '' }}>
                                                    {{ $fuelLabel }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-lg-8">
                                        <select name="status" class="form-select form-select-sm @error('status') is-invalid @enderror" data-control="select2" data-hide-search="true" required>
                                            @foreach($statuses as $status_value)
                                                <option value="{{ $status_value }}" {{ old('status', 'active') == $status_value ? 'selected' : '' }}>
                ...
                <div class="row g-3 mb-4">
                    <div class="col-lg-12">
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body py-3">
                                <textarea name="notes" class="form-control form-control-sm @error('notes') is-invalid @enderror" rows="3" placeholder="{{ __('car.notes_placeholder') }}">{{ old('notes') }}</textarea>
                                @error('notes')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
