<x-app-layout>
    <x-slot name="toolbar">
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                ...
                <li class="breadcrumb-item text-muted">{{ __('roles.add_role') }}</li>
            </ul>
        </div>
    </x-slot>
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">{{ __('roles.create_new_role') }}</h3>
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('roles.store') }}" novalidate>
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-9">
                        <input type="text" name="name" class="form-control form-control-sm @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="e.g. manager, sales-agent" required>
