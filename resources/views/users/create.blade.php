<x-app-layout>
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">{{ __('user.create_user') }}</h3>
                        ...
                        <div class="card h-100 shadow-sm">
                            ...
                            <div class="card-body py-3">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" name="first_name" class="form-control form-control-sm @error('first_name') is-invalid @enderror" value="{{ old('first_name') }}" placeholder="First name" required>
                                        @error('first_name')
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" name="last_name" class="form-control form-control-sm @error('last_name') is-invalid @enderror" value="{{ old('last_name') }}" placeholder="Last name" required>
                                        @error('last_name')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="email" name="email" class="form-control form-control-sm @error('email') is-invalid @enderror" value="{{ old('email') }}" placeholder="Email address" required>
                                        @error('email')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                        ...
                        <div class="card h-100 shadow-sm">
                            ...
                            <div class="card-body py-3">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" name="phone" class="form-control form-control-sm @error('phone') is-invalid @enderror" value="{{ old('phone') }}" placeholder="Phone number">
                                        @error('phone')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" name="phone_extension" class="form-control form-control-sm @error('phone_extension') is-invalid @enderror" value="{{ old('phone_extension') }}" placeholder="Extension">
                        ...
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body py-3">
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <div class="row">
                                            <label class="col-lg-4 col-form-label required fw-semibold fs-7">{{ __('user.password') }}</label>
                                            <div class="col-lg-8">
                                    ...
                                    <div class="col-md-6">
                                        <div class="row">
                                            <label class="col-lg-4 col-form-label required fw-semibold fs-7">{{ __('user.password_confirmation') }}</label>
                                            <div class="col-lg-8">
                                                <input type="password" name="password_confirmation" id="confirm_password" class="form-control form-control-sm @error('password_confirmation') is-invalid @enderror" placeholder="Confirm password" required>
                                    ...
                                    <div class="col-lg-8">
                                        <select name="roles[]" id="roles" class="form-select form-select-sm @error('roles') is-invalid @enderror" data-control="select2" data-placeholder="Select roles" multiple required>
                                            @foreach($roles as $roleValue => $roleLabel)
                                                <option value="{{ $roleValue }}" {{ (old('roles') && in_array($roleValue, old('roles'))) ? 'selected' : '' }}>
                                                    {{ $roleLabel }}
                                                </option>
                                            @endforeach
                                        </select>
